...
===============Surge=================
crazyJoy任务 = type=cron,cronexp="10 7 * * *",wake-system=1,timeout=3600,script-path=jd_crazy_joy.js

============小火箭=========
crazyJoy任务 = type=cron,script-path=jd_crazy_joy.js, cronexpr="10 7 * * *", timeout=3600, enable=true
